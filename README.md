...
| **6회차(25.02.13)** | 제4장 결과를 전달하는 HTTP 상태 코드<br>4.1 상태 코드는 서버로부터 리퀘스트 결과를 전달한다. - p078<br>4.2 2xx 성공(Success) - p079<br>4.3 3xx 리다이렉트(Redirection) - p081<br>4.4 4xx 클라이언트 에러(Client Error) - p085<br>4.5 5xx 서버 에러(Server Error) - p088 | 09:35 ~ 10:40<br> p089 / p314 = 28% |
