...
|**25/02/06(목)**| **2회차** | 제1장 웹과 네트워크의 기본에 대해 알아보자<br>제2장 간단한 프로토콜 HTTP | 1.5 이름 해결을 담당하는 DNS - p028<br>1.6 각각과 HTTP와의 관계 - p029<br>1.7 URI와 URL - p031<br><br>2.1 HTTP는 클라이언트와 서버 간에 통신을 한다. - p038<br>2.2 리퀘스트와 리스폰스를 교환하여 성립 - p039 | 09:30 ~ 10:40<br>p041 / p314 = 13% |
...
|**25/02/11(화)**| **4회차** | 제2장 간단한 프로토콜 HTTP<br>제3장 HTTP 정보는 HTTP 메시지에 있다 | 2.7 지속 연결로 접속량을 절약 - p054<br>2.8 쿠키를 사용한 상태 관리 - p057<br><br>3.1 HTTP 메시지 - p062<br>3.2 리퀘스트 메시지와 리스폰스 메시지의 구조 - p062 | 09:50 ~ 10:30<br>p064 / p314 = 20% |
